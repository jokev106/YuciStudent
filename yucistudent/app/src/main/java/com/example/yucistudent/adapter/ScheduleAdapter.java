...
import com.example.yucistudent.Fragment.ScheduleFragment;
...
public class ScheduleAdapter extends RecyclerView.Adapter<ScheduleAdapter.CardViewViewHolder> {
    ...
    class CardViewViewHolder extends RecyclerView.ViewHolder {
        ...
        CardViewViewHolder(View itemView) {
            super(itemView);
            lbl_subject = itemView.findViewById(R.id.scheduleadapterCourseName);
            lbl_schedule = itemView.findViewById(R.id.scheduleadapterCourseSchedule);
            lbl_lecturer = itemView.findViewById(R.id.scheduleadapterLecturerName);
            btn_delete = itemView.findViewById(R.id.removebutton);
        }
    }
}