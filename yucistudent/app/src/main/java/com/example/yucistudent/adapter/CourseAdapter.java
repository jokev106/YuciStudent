...
public class CourseAdapter  extends RecyclerView.Adapter<CourseAdapter.CardViewViewHolder> {
    ...
    class CardViewViewHolder extends RecyclerView.ViewHolder {
        ...
        CardViewViewHolder(View itemView) {
            super(itemView);
            lbl_subject = itemView.findViewById(R.id.CourseName);
            lbl_schedule = itemView.findViewById(R.id.Schedule);
            lbl_lecturer = itemView.findViewById(R.id.LecturerName);
