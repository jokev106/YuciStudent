package com.example.yucistudent.adapter;
...
import com.example.yucistudent.Model.Lecturer;
...
public class EnrollAdapter extends RecyclerView.Adapter<EnrollAdapter.CardViewViewHolder> {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (checkOverlap.getValue() != null) {
                    if (checkOverlap.getValue()) {
                        Toast.makeText(context, "You already have antoher class at this time!", Toast.LENGTH_SHORT).show();
                    } else {
    ...
    class CardViewViewHolder extends RecyclerView.ViewHolder {
        ...
        CardViewViewHolder(View itemView) {
            super(itemView);
            lbl_subject = itemView.findViewById(R.id.enrollCourseName);
            lbl_schedule = itemView.findViewById(R.id.enrollCourseSchedule);
            lbl_lecturer = itemView.findViewById(R.id.enrollLecturerName);
            btn_enroll = itemView.findViewById(R.id.enrollbutton);
        }
    }
}
