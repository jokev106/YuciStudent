...
import com.example.yucistudent.adapter.CourseAdapter;
...
public class CourseData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coursetoolbaR = findViewById(R.id.coursedatatoolbar);
        courseDatarecyclerview = findViewById(R.id.RecyclerViewCourseData);
    ...
    private void fetchCourseData() {
        dbCourse.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                listCourse.clear();
                courseDatarecyclerview.setAdapter(null);
    ...
    private void showCourseData(ArrayList<Course> list) {
        courseDatarecyclerview.setLayoutManager(new LinearLayoutManager(CourseData.this));
        CourseAdapter courseAdapter = new CourseAdapter(CourseData.this);
        courseAdapter.setListCourse(list);
        courseDatarecyclerview.setAdapter(courseAdapter);
    }
